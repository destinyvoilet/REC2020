...
if __name__ == '__main__':
    raw = pd.read_csv('./aiA/09118120徐浩卿/raw_2_humanities.csv')
    X = raw[['uni_rank', 'dif_long','dif_lati']]
    y = raw[['score']]
    ...
    model1 = Model2().double().cuda()
    criterion = Model2Loss().cuda()
    ...
    torch.save(model1.state_dict(),'./aiA/09118120徐浩卿/humanities.mod2')
